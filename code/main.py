...
my_transforms = transforms.Compose([
    transforms.ToTensor(),
    #Original Dataset => Mean = 0.507395, Std = 0.2551289
    #Clean Dataset => Mean = 0.55199619, Std = 0.2486985
    transforms.Normalize(mean=[0.55199619],std=[0.2486985])
])

dataset = image_Dataset(csv_file = '../data/cleaned_emotion_dataset.csv', transform = my_transforms)

#Dividing the dataset into two parts
train_set, test_set = torch.utils.data.random_split(dataset, [1000, 187])
